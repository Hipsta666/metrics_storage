"""
Это вспомогательный скрипт для тестирования сервера из задания 3.2.

Для запуска скрипта на локальном компьютере разместите рядом файл client.py,
где содержится код клиента, который разработан Вами в задании 3.1.
...
def run(host, port):
    ...
    print("Похоже, что все верно! Попробуйте пройти очную защиту Вашего задания.")
